...
//            repository.findByCity(product.getCity());
    ...
    @Override
    public Set<Product> getProductByProductCategory(String productCategory) throws CategoryNotFoundException {
        if(categoryRepository.findByProductCategory(productCategory).isEmpty())
        {
            throw new CategoryNotFoundException();

        }
        return new HashSet<>(categoryRepository.findByProductCategory(productCategory));
